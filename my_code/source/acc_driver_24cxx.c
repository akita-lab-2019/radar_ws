 ...
 */
static bool acc_driver_24cxx_get_size(size_t *memory_size)
{
 ...
 * @return True if successful, false otherwise
 */
static bool acc_driver_24cxx_read(uint32_t address, void *buffer, size_t size)
{
 ...
 * @return True if successful, false otherwise
 */
static bool acc_driver_24cxx_write(uint32_t address, const void *buffer, size_t size)
{
	bool success = true;
