 ...
 * No timing is guaranteed in this mode.
 *
 ...
 *
 * Gets the number of hardware accelerated averaged samples for each data point.
 *
 * @param[in] configuration The sweep configuration to get hardware accelerated average samples from
 ...
 *
 * Sets the number of hardware accelerated averaged samples for each data point.
 *
 * @param[in] configuration The sweep configuration to set hardware accelerated average samples in
